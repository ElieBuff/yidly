WebsocketRails.setup do |config|
  ...
  ENV['WEBSOCKET_PORT'] = ':3000' unless Rails.env.production?
...
WebsocketRails::EventMap.describe do
  ...
  #subscribe :client_connected, :to => TaskfunsController, :with_method => :create
  #
  ...
  namespace :tasks do
    subscribe :get, :to => TaskfunsController, :with_method => :get_all
  end
end
